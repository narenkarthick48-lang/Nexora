...
function bindStaticEvents() {
  ...
  // ---- Google auth ----
  // Mobile browsers frequently block popups, which makes signInWithPopup fail
  // silently. signInWithRedirect sends the whole page to Google and back,
  // which is far more reliable on phones (this is what most apps use).
  ...
  // Finish the redirect-based sign-in once Google sends the user back.
